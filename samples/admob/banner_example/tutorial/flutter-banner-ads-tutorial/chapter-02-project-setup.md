...
在本章中，我们将学习如何配置 Flutter 项目以支持 Google Mobile Ads，包括创建项目、添加依赖、配置 Android 和 iOS 平台设置，以及获取测试广告单元 ID。这是实现 Banner Ads 的基础步骤。
...
- **Android Banner Ads**: `ca-app-pub-3940256099942544/9214589741`
- **iOS Banner Ads**: `ca-app-pub-3940256099942544/2435281174`
...
配置完成后，我们就可以开始编写代码了。在下一章中，我们将学习如何获取自适应横幅广告尺寸，这是实现 Banner Ads 的第一步。

继续学习：[第 3 章：自适应横幅广告尺寸](chapter-03-ad-size.md)
