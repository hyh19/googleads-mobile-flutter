...
在本章中，我们将学习如何配置 Flutter 项目以支持 Google Mobile Ads，包括创建项目、添加依赖、配置 Android 和 iOS 平台设置，以及获取测试广告单元 ID。这是实现 App Open Ads 的基础步骤。
...
```bash
flutter create app_open_example
cd app_open_example
```
...
- **Android App Open Ads**: `ca-app-pub-3940256099942544/9257395921`
- **iOS App Open Ads**: `ca-app-pub-3940256099942544/5575463023`
...
配置完成后，我们就可以开始编写代码了。在下一章中，我们将创建 `AppOpenAdManager` 类，这是管理 App Open Ads 的核心组件。

继续学习：[第 3 章：创建广告管理器基础类](chapter-03-ad-manager-basics.md)
