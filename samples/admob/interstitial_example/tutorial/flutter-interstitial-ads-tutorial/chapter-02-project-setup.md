...
在本章中，我们将学习如何配置 Flutter 项目以支持 Google Mobile Ads，包括创建项目、添加依赖、配置 Android 和 iOS 平台设置，以及获取测试广告单元 ID。这是实现 Interstitial Ads 的基础步骤。
...
```bash
flutter create interstitial_example
cd interstitial_example
```
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        android:label="interstitial_example"
...
- **Android Interstitial Ads**: `ca-app-pub-3940256099942544/1033173712`
- **iOS Interstitial Ads**: `ca-app-pub-3940256099942544/4411468910`
...
3. 导航到「广告单元」页面
4. 点击「创建广告单元」
5. 选择「Interstitial」广告格式
6. 为广告单元命名
7. 复制生成的广告单元 ID

### 创建 Interstitial 广告单元
...
2. 点击「创建广告单元」
3. 选择「Interstitial」
4. 输入广告单元名称（例如："Interstitial - Game Over"）
5. 点击「创建」
...
配置完成后，我们就可以开始编写代码了。在下一章中，我们将学习如何使用 `InterstitialAd.load()` 方法加载插屏广告。

继续学习：[第 3 章：加载插屏广告](chapter-03-loading-ads.md)
